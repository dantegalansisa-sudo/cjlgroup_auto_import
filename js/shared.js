// ═══════════════════════════════════════════
// SHARED.JS — CJL Group Auto Import
...
window.buildWhatsAppLink = function(vehiculo) {
  ...
  var msg = encodeURIComponent(
    'Hola, escribo desde su sitio web (https://cjlgroup-auto-import.vercel.app) y me interesa el ' +
    vehiculo.marca + ' ' + vehiculo.modelo + ' ' + vehiculo.ano + price +
    '. ¿Tiene disponibilidad?'
  );
  return 'https://wa.me/18097615630?text=' + msg;
};
